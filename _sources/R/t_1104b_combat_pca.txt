Site-correction with ComBat - PCA analysis
""""""""""""""""""""""""""""""""""""""""""
The source R script available :download:`here <t_1104b_combat_pca.R>`
...
**About this document** See if the effect of *site-difference* manifests
itself as *batch-effect*.
...
::
    ...
    ## [1] "/home/takanori/Dropbox/work/sbia_work/python/now/R"
...
(am i missing something? google-search told me ``ggpair`` got
deprecated...)
...
So looks like the site differences got removed quite nicely. Next we'll
see if **age-related biological variation** was preserved (our variation
of interest). We'll run machine-learning/regression-analysi for this.
Let's move over to Python and Scikit-Learn for this...)

Save ComBat corrected data-matrix
=================================

Save as ``.mat`` file for analysis in python (in my experience, ``.mat``
has nice compression for purely numerical arrays like this)

.. code-block:: R

    R.matlab::writeMat('Xcombat_mod0.mat',X_combat=X_combat0)

.. |image0| image:: t_1104b_combat_pca_files/figure-html/unnamed-chunk-5-1.png
.. |image1| image:: t_1104b_combat_pca_files/figure-html/unnamed-chunk-6-1.png
.. |image2| image:: t_1104b_combat_pca_files/figure-html/unnamed-chunk-8-1.png
